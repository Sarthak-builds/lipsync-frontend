...
const Sidebar: React.FC = () => {
    ...
    return (
        <div className=" w-56   border-gray-400  h-full min-h-screen   sticky top-0  flex flex-col text-[14px] font-medium  gap-12 font-geist justify-start items-start  text-white bg-[#0d0d0f]">
            <div className=" border-0 bg-gradient-to-r from-blue-500 via-purple-500 to-blue-500 flex justify-center items-center  font-semibold text-lg w-52  text-netural-900 font-geistmono rounded-sm mx-2 my-6 p-[0.5px]">
                <div className="w-full h-full flex justify-center items-center bg-[#0d0d0f] rounded-sm px-3 py-0.5">
                    LIPSYNC AI
                </div>
            </div>
