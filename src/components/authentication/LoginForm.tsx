        ...
        <div className="w-full max-w-sm space-y-8">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-center">
                  ...
                  <a href="#" className="text-xs text-[#5c5852] hover:text-[#385942] dark:hover:text-[#7ea68a] transition-colors font-semibold">
                    Forgot?
                  </a>
                </div>
                <input
          ...
          <div className="space-y-4">
            <p className="text-center text-sm text-[#5c5852] dark:text-[#a39e95]">
              ...
              <Link to="/register" className="font-semibold text-[#385942] dark:text-[#7ea68a] hover:underline underline-offset-4">
                Sign up
              </Link>
            </p>
